# Tea_Train_PatchBased_tfdata.py
...
input_folder_features = r"C:/Users/Zahem Saldin/Desktop/Tea_CNN_Input"   
input_folder_labels = r"C:/Users/Zahem Saldin/Desktop/Tea_SoftLabels"       
...
csv_logger = CSVLogger("tea_training_log.csv", append=False)
...
callbacks = [
    ...
    ModelCheckpoint("best_tea_model.keras", save_best_only=True, monitor='val_loss'),
    csv_logger
]
...
model.save("tea_patch_based_softlabel_cnn_improved.keras")
print("Final model saved as 'tea_patch_based_softlabel_cnn_improved.keras'")
...
if os.path.exists("tea_training_log.csv"):
    log = pd.read_csv("tea_training_log.csv")
