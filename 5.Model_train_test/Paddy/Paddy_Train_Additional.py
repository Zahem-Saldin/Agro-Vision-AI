# Paddy_Train_PatchBased_tfdata_Improved.py
...
input_folder_features = r"C:/Users/Zahem Saldin/Desktop/GEE_Export_CNN_Input"  
input_folder_labels = r"C:/Users/Zahem Saldin/Desktop/GEE_Export_SoftLabels"  
...
callbacks = [
    ...
    ModelCheckpoint("best_paddy_model.keras", save_best_only=True, monitor='val_loss'),
    csv_logger
]
...
model.save("paddy_patch_based_softlabel_cnn_improved.keras")
print("✅ Final model saved as 'paddy_patch_based_softlabel_cnn_log.keras'")
